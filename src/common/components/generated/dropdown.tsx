...
const dropdownItemStyles = tv({
  base: [
    'col-span-full grid grid-cols-[auto_1fr_1.5rem_0.5rem_auto] not-has-data-[slot=dropdown-item-details]:items-center has-data-[slot=dropdown-item-details]:**:data-[slot=checked-icon]:mt-[1.5px]',
...
function DropdownLabel({ className, ref, ...props }: MenuLabelProps) {
  return <Text slot="label" ref={ref} className={cn('col-start-2', className)} {...props} />
}
